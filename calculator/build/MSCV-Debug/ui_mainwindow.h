...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(tb_divide, 5, 4, 1, 1);
        ...
        gridLayout->addWidget(tb_add, 9, 4, 1, 1);
        ...
        gridLayout->addWidget(tb_substract, 7, 4, 1, 1);
        ...
        gridLayout->addWidget(tb_multiplicate, 6, 4, 1, 1);
        ...
        gridLayout->addWidget(tb_power, 3, 4, 1, 1);
        ...
        gridLayout->addWidget(tb_equal, 10, 4, 1, 1);
        ...
        horizontalLayout_2->addWidget(cmb_controller);
        ...
        horizontalLayout_2->addWidget(l_formula);


        gridLayout->addLayout(horizontalLayout_2, 0, 1, 1, 4);
